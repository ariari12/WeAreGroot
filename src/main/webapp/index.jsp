    ...
    <div class="div-wrapper">
      ...
      <div class="frame-2">
        ...
        <div class="frame-15">
          ...
          <div class="frame-16">
            <img class="frame-17" src="img/frame-30.svg" />
            <div class="frame-18">
            ...
            <img class="frame-17" src="img/frame-35.svg" />
          </div>
        </div>
      </div>
      ...
      <div class="frame-wrapper">
        <div class="frame-25">
          <div class="frame-26"><div class="text-wrapper-26">로그인</div></div>
          <div class="frame-26"><div class="text-wrapper-26">회원가입</div></div>
        </div>
      </div>
    </div>
  </body>

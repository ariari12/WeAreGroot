				...
				<div class="container">
					...
					<form action="board" method="get">
						<table class="table">
							<tr>
								<th>제목</th>
								<td><input type="text" name="title" /> <input type="hidden"
									name="cmd" value="qnaModifyOk" /> <input type="hidden"
									name="bId" value="<%=bId%>" /></td>
							</tr>
							...
							<tr>
								<td rowspan="2">
									<button class="btn btn-success" type="button"
										onclick="location.href='?cmd=qna'">QnA로 이동</button> <input

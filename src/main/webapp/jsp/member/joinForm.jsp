...
<style>
  ...
  .div-wrapper form button[type="submit"] {
    position: absolute;
    bottom: 500px;
    left: 50%;
...
<script>
  ...
  <body>
    <div class="div-wrapper">
      ...
      <div class="frame">
        <div class="div">
          <div class="frame-2"><div class="text-wrapper">로그인</div></div>
          <div class="frame-2"><div class="text-wrapper">회원가입</div></div>
        </div>
      </div>
      
      <div class="frame-3">
        <div class="frame-4">
          <div class="frame-5"><div class="text-wrapper-14">홈</div></div>
          <div class="frame-5"><div class="text-wrapper-14">커뮤니티</div></div>
          <div class="frame-5"><div class="text-wrapper-14">스토어</div></div>
          <div class="frame-5"><div class="text-wrapper-14">공지</div></div>
          <div class="frame-5">
            <div class="text-wrapper-14">이벤트</div>
            <div class="ellipse"></div>
          </div>
          <div class="frame-5"><div class="text-wrapper-14">1:1 문의</div></div>
        </div>
        <div class="frame-6">
      ...
      <img class="img" src="img/line-13.svg" />
      <div class="text-wrapper-17">필수정보</div>
      <p class="text-wrapper-19">반가워요! 회원가입에 필요한 정보들을 작성해주세요</p>

      <div class="frame-17">
        <div class="text-wrapper-20">이름</div>
        <input type="text" name="name" class="frame-11 text-wrapper-21" placeholder="이름을 입력해주세요 (필수)" required>
      </div>
      ...
      <div class="frame-14">
        ...
        <input type="password" name="pw" class="frame-11 text-wrapper-21" placeholder="비밀번호 (영문/숫자/특수번호 조합 8자 이상)" required>
      </div>
      ...
      <div class="frame-13">
        ...
        <input type="password" name="repw" class="frame-11 text-wrapper-21" placeholder="입력하신 비밀번호를 한 번 더 입력해주세요" required>
      </div>

      <div class="frame-12">
        <div class="text-wrapper-20">휴대폰 번호</div>
        <input type="tel" name="phone" class="frame-11 text-wrapper-21" placeholder="휴대폰 번호를 입력해주세요" required>
      </div>

      <div class="frame-10">
        <div class="text-wrapper-20">생년월일</div>
        <input type="text" name="birth" class="frame-11 text-wrapper-21" placeholder="생년월일을 입력해주세요(Ex: 19990101)" required>
      </div>
      ...
      <div class="frame-21">
        <label><input type="checkbox" id="agreeAll" class="rectangle"> 모두 동의합니다</label>
      </div>

      <div class="frame-22">
        <label><input type="checkbox" name="agreement" value="term1" required class="rectangle-2"> 이용약관이용약관이용약관이용약관(필수)</label>
        <div class="text-wrapper-26">약관보기&gt;</div>
      </div>

      <div class="frame-23">
        <label><input type="checkbox" name="agreement" value="term2" class="rectangle-2"> 이용약관이용약관이용약관이용약관(선택)</label>
        <div class="text-wrapper-26">약관보기&gt;</div>
      </div>

      <div class="frame-24">
        <label><input type="checkbox" name="agreement" value="term3" class="rectangle-2"> 이용약관이용약관이용약관이용약관(선택)</label>
        <div class="text-wrapper-26">약관보기&gt;</div>
      </div>

      <div class="frame-25">
        <label><input type="checkbox" name="agreement" value="term4" class="rectangle-2"> 이용약관이용약관이용약관이용약관(선택)</label>
        <div class="text-wrapper-26">약관보기&gt;</div>
      </div>
    ...
    <div class="view">
        ...
        <p class="text-wrapper-3">12345) 서울특별시 모란구 모란동 123, Tel : 1234-5678</p>
        <p class="text-wrapper-4">Fax : 02-123-4567 / E-mail: moranmoran@moran.com</p>
        <p class="text-wrapper-5">사업자등록번호 : 123-45-67890, 통신판매업신고 : 2024-서울구구-3456</p>
        <p class="UI-copyright">
          <span class="span"
            ...
            등의 행위는 엄격히 금지됩니다.<br
          /></span>
          <span class="text-wrapper-6">Copyright MoranMoran Co. All Rights Reserved.</span>
        </p>
